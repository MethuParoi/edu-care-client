...
const EditModal = ({ meal_id, setMeal_id, uniDetail, refetch }) => {
  ...
  useEffect(() => {
    if (uniDetail) {
      //   console.log("meal detail",  uniDetail);
      reset({
        mealType: uniDetail.mealType,
        title: uniDetail.title,
        price: uniDetail.price,
        distributorName: uniDetail.distributorName,
        description: uniDetail.description,
        ingredients: uniDetail.ingredients,
      });
    }
  }, [uniDetail, reset]);
  ...
  const onSubmit = async (data) => {
    setIsLoading(true);
    let mealImage = uniDetail.mealImage; // Default to existing image
    ...
    try {
      const response = await axiosSecure.patch(
        `university/update-university/${meal_id}`,
        mealData
      );
